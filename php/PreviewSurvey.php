...
<body>
    ...
    <div class="status"><label>Survey Preview</label> </div>
    ...
    <?php
        ...
        function  generateParagraphBox($con,$question_id)
        {
            ...
            <div class="commentBoxContainer" style="padding:1%;"> 
                ...
                <textarea disabled="true" name="<?php echo "comment_paragraph_".$question_id; ?>" id="" cols="70" maxlength="250" placeholder="Maximum 250 characters" style="font-family: sans-serif;"  rows="10" ></textarea>
        ...
        function generateDateBox($con,$question_id)
        {
            ...
            <input type="date" class="datetype"  name="<?php echo $uni_name; ?>" disabled="true" required="true"/>
           ...
           // echo mysqli_num_rows($query_run);
            ...
            while($i <= 30)
            {
                ...
                if($cell_option[$optxt] != "null")
                {
                    ?>
                        <div class="optionBox">
                        <input type="radio" name="<?php echo $uniName ?>" value="<?php echo $cell_option[$optxt]; ?>" required="true" disabled="true"> <?php echo $cell_option[$optxt];?> 
            ...
            if($cell_option['otherTXT'] == "true")
            {
                ...
                <div class="other">
                    ...
                    <textarea name="" id="otherTXT" cols="30" rows="4" placeholder="maximum 100 characters" readonly="false" maxlength="100" disabled="true"></textarea>
                </div>
         <?php   }
                    ...
                    while($i <= 30)
                    {
                        ...
                        ?>
                           <div class="CheckBoxCont">
                            <input disabled="true" type="checkbox" name="<?php echo $checkBox_name; ?>" value="<?php echo $cell_chkBox[$chkBox_Index]; ?>"><?php echo $cell_chkBox[$chkBox_Index];?>
                      ...
                      elseif($cell_chkBox[$chkBox_Index] == "null") {
                        ...
                        <input type="checkbox" disabled="true" name="<?php echo $checkBox_name; ?>" id="" value="<?php echo $cell_chkBox[$chkBox_Index]; ?>"><?php echo $cell_chkBox[$chkBox_Index];?>
      ...
      ?>      
            <div style="padding:1%;">
            <select disabled="true" name="<?php echo $drop_name; ?>" style="font-size: 18px;width: 24%;" >
...
<section>
                <input type="button" id="THEGoBackBTN" onclick="goBack()" value="Go Back" />
                <script type="text/javascript">
                function goBack()
                {
                    
                    window.location.href="homeBusinessHTML2.php";
                }
                </script>
                </section>
</body>
